 ...
 * @author KelvinOjeda
 */
public class PlayermateOne extends Player {
    ...
    public PlayermateOne(Vector2D position,
            Vector2D velocity,
            double maxVelocity,
    ...
    public void resetValues() {
        ...
        position = new Vector2D(Constant.WIDTH / 4 - Asset.player1.getWidth() / 2,
