...
public class ScoreManager extends JPanel {
    ...
    public ScoreManager() {
        ...
        scoreComparator = new Comparator<User>() {
            ...
            public int compare(User userScore1, User userScore2) {
                return userScore1.getSnakeGameScore() < userScore2.getSnakeGameScore() ? -1
                        : userScore1.getSnakeGameScore() > userScore2.getSnakeGameScore() ? 1
                        : 0;
            }
        };
        ...
        try {
            ...
            for (int i = 0; i < dataList.size(); i++) {
                if (dataList.get(i).getSnakeGameScore() != 0) {
    ...
    public static void drawText(Graphics g, String string, Position position, boolean center, Color color, Font font) {
        g.setColor(color);
        g.setFont(font);
    ...
    public void paint(Graphics g) {
        ...
        for (int i = auxArrayScoreDataUser.length - 1; i > -1; i--) {
            ...
            drawText(g, Integer.toString(auxScoreDataUser.getSnakeGameScore()),
